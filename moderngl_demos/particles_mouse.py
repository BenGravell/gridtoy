...
class Particles(Example):
    ...
    def __init__(self, **kwargs):
        ...
        self.transform['gravity'].value = -0.05  # affects the velocity of the particles over time
        self.ctx.point_size = self.wnd.pixel_ratio * 3  # point size

        self.N = 10000  # particle count
    ...
    def mouse_position_event(self, x, y, dx, dy):
        ...
        self.mouse_velocity = dx / 40, -dy / 40
